...
import (
	...
	keystore "github.com/tonyHup/go-ipfs/keystore"
	repo "github.com/tonyHup/go-ipfs/repo"
	"github.com/tonyHup/go-ipfs/repo/common"
	mfsr "github.com/tonyHup/go-ipfs/repo/fsrepo/migrations"
	dir "github.com/tonyHup/go-ipfs/thirdparty/dir"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/tonyHup/go-ipfs/blob/master/docs/datastores.md#flatfs.")
	}
