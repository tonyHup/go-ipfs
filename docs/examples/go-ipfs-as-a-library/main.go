...
import (
	...
	"github.com/tonyHup/go-ipfs/core/coreapi"
	"github.com/tonyHup/go-ipfs/plugin/loader" // This package is needed so that all the preloaded plugins are loaded automatically
